					...
					<div class="card-content blue-text">
                        ...
                        <div >
							...
							<select name="id_categoria" required>
								...
								<?php else: ?>
								<option required <?=$c->id_categoria == $id_categoria ? 'selected' : ""; ?>>
									<?=$c->tipo_habitacion; ?>
								</option>
								<?php endif ?>
								<?php endforeach; ?>
					...
					<br>
                        ...
                        <label class="form-label">Nivel de habitacion</label>
							<select name="id_nivel" class="form-select" required>
								...
								<?php else: ?>
								<option required value="<?=$n->id_nivel?>" <?=$n->id_nivel == $id_nivel ? 'selected' : ""; ?>>
									<?=$n->nombre_nivel; ?>
								</option>
								<?php endif ?>
								<?php endforeach; ?>
                        ...
                        <label class="form-label">Estado de habitacion</label>
							<select name="id_tipo_estado" id="estado"   class="form-select">
								...
								<?php else: ?>
								<option required value="<?=$e->id_tipo_estado?>" <?=$e->id_tipo_estado == $id_tipo_estado ? 'selected' : ""; ?>>
									<?=$e->estado_habitacion; ?>
								</option>
								<?php endif ?>
								<?php endforeach; ?>
