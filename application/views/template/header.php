 ...
 <?php foreach ($allPagina as $p) : ?>
   ...
   <script type="text/javascript">
     window.onload = function() {
       ...
       if (crear == "No" || crear == "NO" || crear == "no") {
         $('.aDynamic').addClass('btn disabled');
       }
       if (editar == "No" || editar == "NO" || editar == "no") {
         $('.btnEdit').addClass('btn disabled');
       }
       if (eliminar == "No" || eliminar == "NO" || eliminar == "no") {
         $('.btnDel').addClass('btn disabled');
       }
     }
   </script>
